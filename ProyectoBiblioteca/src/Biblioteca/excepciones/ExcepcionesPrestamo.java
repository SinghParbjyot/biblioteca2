...
public class ExcepcionesPrestamo extends Exception{
	...
	public static final String MENSAJE_PRESTAMO_NO_DEVUELTO = "No existe ningún préstamo no devuelto en la base de datos.";
	public static final String MENSAJE_NO_EXISTE_PRESTAMO_FECHA_BD = "No existe ningún préstamo realizado en esa fecha en la base de datos.";
